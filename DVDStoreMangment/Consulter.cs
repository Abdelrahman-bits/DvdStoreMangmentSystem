...
namespace DVDStoreMangment
{
    public partial class FicConsulter : Form
    {
        ...
        {
            // List<string> stringlist = new List<string>();
            string stringlist = "<!DOCTYPE html><html><head> <meta charset ='utf-8'/><title> The stock </title> </head> <style>table, th, td {border: 1px solid black;border - collapse: collapse;}</style> <body> <h2 style = 'color:red'> Our Stock </h2> <table style = 'width:100%; background-color:#b8bafd'><tr><th> DVD ID </th><th> DVDs Present </th><th> Number In Stock</th></tr>";
